                            ...
                            <div class="text-logo">
                                <a href="http://localhost:8080">
                                    <ul class="list-inline-block">
                                        <li><img class="wp-image-316 aligncenter" src="/assets/images/anhshop.jpg" alt=""
                                                 width="215" height="213" />
                    ...
                    <div class="wpb_wrapper">
                        <nav class="main-nav  main-nav1 menu-sticky-on">
                            <ul id="menu-home-menu" class="list-none">
                                ...
                                <li id="nav-menu-item-2522"
                                    ...
                                    <ul class="sub-menu menu-odd  menu-depth-1">
                                        <li id="nav-menu-item-2550"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                               class="menu-link sub-menu-link">Cát</a>
                                        </li>
                                        <li id="nav-menu-item-2549"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                               class="menu-link sub-menu-link">Chuồng</a>
                                        </li>
                                        <li id="nav-menu-item-25450"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                               class="menu-link sub-menu-link">Vòng cổ</a>
                                        </li>
                                        <li id="nav-menu-item-25449"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                               class="menu-link sub-menu-link">Bát ăn</a>
                                        </li>
                                    </ul>
                                </li>
                                <li id="nav-menu-item-2562"
                                    class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children">
                                    <a href="?action=3"
                                       class="menu-link main-menu-link">Dịch vụ</a>
                                    <ul class="sub-menu menu-odd  menu-depth-1">
                                        <li id="nav-menu-item-2560"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                               class="menu-link sub-menu-link">SPA</a>
                                        </li>
                                        <li id="nav-menu-item-249"
                                            class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                            <a href="http://localhost:8080/"
                                ...
                                <li><a class="menuitem" href="/login">Đăng nhập </a></li>
                            </ul> <a href="#" class="toggle-mobile-menu"><span></span></a>
                        </nav>
                        <div class="mini-cart-box mini-cart1 aside-box vc_custom_1576244154005">
                            <a class="mini-cart-link bg-color" href="/login">
                                        <span class=""><i
                                                class=""></i></span>
                                <span class="mini-cart-text">
                            <strong class="mini-cart-title white">GIỏ hàng</strong>
                            <c:set var="quan" value="0"></c:set>
                            <c:forEach var="item" items="${sessionScope.listSessionCartSanpham}">
                                <c:set var="quan" value="${quan +item.getSoluongtronggio()}"></c:set>
                            </c:forEach>
                            <span class="mini-cart-number white set-cart-number">${quan} </span> <span
                                    ...
                                    <div class="wpb_wrapper">
                                        ...
                                        <div  class="block-element block-search-element main-search-form vc_custom_1582939942088" style="text-align: right; padding: 8px;">
                                            <form method="get" action="">
                                                ...
                                                <input class="search-input-detail" type="text" name="search" placeholder="Nhập sản phẩm cần tìm kiếm..."style=" width: 600px">
                                                <input class="search-detail" type="submit" value="search">
                                            </form>
                                        </div>
                                    </div>
                                </div>
