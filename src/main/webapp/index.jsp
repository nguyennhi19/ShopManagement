...
<%@ page import="shopthucung.model.Product" %>
<%@ page import="shopthucung.utils.DBConnection" %>
<%--
                    ...
                    <div class="vc_column-inner vc_custom_1576307239909">
                      <div class="wpb_wrapper">
                        ...
                        <div class="row justify-content-around">
                          ...
                          <c:forEach var="sanpham" items='${requestScope["listPe"]}' begin="0" end="7">
                            <div class="col-3">
                              ...
                              <div class="product-info">
                                ...
                                <div class="product-price simple">
                                    <span
                                      ...
                                      <a style="margin-left: 75px" href="/login">Buy</a>
                                    </span>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="wpb_raw_code wpb_content_element wpb_raw_html">
                          <div class="wpb_wrapper">
                            <a class="shop-button bg-color  block-right"
                  ...
                  <div class="wpb_column column_container col-sm-12">
                    <div class="vc_column-inner vc_custom_1576307249231">
                      <div class="wpb_wrapper">
                        ...
                        <div class="row justify-content-around">
                          <c:forEach var="sanpham" items='${requestScope["listP"]}' begin="0" end="7">
                            <div class="col-3">
                              <div class="product-thumb">
                                <a href="?action=infop&id=${sanpham.getId()}"
                                   class="product-thumb-link zoom-thumb">
                  ...
                  <div class="wpb_column column_container col-sm-12">
                    <div class="vc_column-inner vc_custom_1576307254892">
                      <div class="wpb_wrapper">
                        ...
                        <div class="row justify-content-around">
                          <c:forEach var="sanpham" items='${requestScope["listS"]}' begin="0" end="3">
                            <div class="col-3">
                              <div class="product-thumb">
                                <a href="?action=infop&id=${sanpham.getId()}"
                                   class="product-thumb-link zoom-thumb">
...
//    out.print("connection success! <br><br>");
    System.out.println("connection success! <br><br>");
...
//    out.print("<a href='/homes'>Home<a>");
    System.out.println("<a href='/homes'>Home<a>");
  }
%>
</body>
</html>
