                                        ...
                                        <div class="vc_column-inner vc_custom_1576307239909">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div  class="row justify-content-around">
                                                    <c:forEach var="sanpham" items="${listP}">
                                                        <div class="col-3">
                    ...
                    <div class="wpb_wrapper">
                        <div class="custom-information  ">
                            <div class="footer-box">
                                <h2>Liên lạc</h2>
                                <div>
                                    <p></i><strong>Địa chỉ: </strong>Số 225 Tăng Bạt Hổ - Phú Thuận - Huế
                                    </p>
                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper">
                        <div class="custom-information  ">
                            ...
                            <div>
                                <ul>
                                    <li href="#"><a>Thú cưng là người bạn, mang đến niềm vui, niềm an ủi cho
                                        con
